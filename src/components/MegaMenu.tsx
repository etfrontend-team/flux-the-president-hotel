...
const images: Record<ImageKey, { src: string; alt: string }> = {
  stay: {
    src: "/images/menu-stay.jpg",
    alt: "A guest room at The President Hotel",
  },
  taste: {
    src: "/images/menu-taste.jpg",
    alt: "Dining on the terrace at The President Hotel",
  },
  wellness: {
    src: "/images/menu-wellness.jpg",
    alt: "The Sea Point coastline near the hotel",
  },
};
        ...
        <div
          ...
          <div className="flex flex-1 flex-col justify-center px-40 max-425:px-25 py-40 max-1024:gap-0 992:px-131">
            <Stack
              ...
              <ul className="group/navlist flex flex-col max-992:gap-21 gap-30 font-body max-992:text-15 text-18 leading-12 font-normal tracking-10 text-brand uppercase">
              ...
              <ul className="group/navlist flex flex-col max-992:gap-21 gap-25 font-body text-15 leading-12 font-light tracking-10 text-ink capitalize max-1024:mx-auto">
                {utilityLinks.map((link, index) => (
                  <li
                    ...
                    style={{
                      transitionDelay: contentDelay(utilityStartIndex + index),
                    }}>
                    <NavLink href={link.href} onClick={close}>
                      {link.label}
                    </NavLink>
                  </li>
                ))}
            ...
            <Stack
              ...
              <Stack
                ...
                tabletGap={20}
                mobileGap={20}
                className="font-body text-13 leading-muted font-light tracking-5 text-ink">
                <Link
                  href="tel:+27214348111"
                  onClick={close}
                  className="hover:opacity-70">
                  +27 21 434 8111
                </Link>
                <Link
                  href="mailto:reservations@thepresident.co.za"
                  onClick={close}
                  className="hover:opacity-70">
          ...
          <Stack
            ...
            style={{
              transform: `translateY(-${
                (activeIndex + 1) * (IMAGE_SLOT_HEIGHT + IMAGE_SLOT_GAP) +
                IMAGE_SLOT_HEIGHT / 2
              }px)`,
            }}>
