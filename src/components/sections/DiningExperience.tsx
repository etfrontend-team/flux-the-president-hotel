  ...
  return (
    <section className="general-padding">
      <Container variant="lg">
        <div className="px-38 max-992:px-11 grid grid-cols-[269px_1fr] gap-x-30 max-992:block">
          <div className="max-992:hidden">
            <Stack
              gap={25}
              tabletGap={25}
              mobileGap={25}
              className="sticky top-74 rounded-card border border-brand/10 bg-paper-alt/40 px-35 py-40">
              ...
              <FadeIn key={card.title} delay={index * 0.3}>
                <div
                  ...
                  <Stack
                    ...
                    mobileGap={30}
                    className="max-w-650">
                    <p className="font-accent text-13 tracking-5 text-accent uppercase">
                      {card.eyebrow}
                    </p>
                    <Stack gap={25} tabletGap={25} mobileGap={25}>
                      ...
                      <Prose className="opacity-80 max-w-full">
                        {card.description}
                      </Prose>
                    </Stack>
                  </Stack>
