...
const events: EventItem[] = [
  {
    ...
    description:
      "Lorem ipsum dolor sit amet consectetur. Ullamcorper quam pellentesque porttitor nisi quis.",
      ...
      <Container variant="lg" className="max-992:px-26">
        ...
        <div className="grid grid-cols-1 992:gap-50 992:grid-cols-2 992:items-start 1199:px-38">
          <div className="order-1 flex flex-col items-center text-center 992:order-2 992:col-start-2 992:row-start-1 992:items-start 992:text-left">
            <div className="flex flex-col items-center 1024:px-25 max-992:mb-50 992:items-start pl-25 w-full">
              <Stack
                align="center"
                gap={30}
                tabletGap={30}
                mobileGap={30}
                className="mb-35 992:items-start">
                <span className="font-accent text-16 tracking-5 text-accent uppercase">
                  At the president
                </span>
              ...
              <Button
                ...
                variant="glass"
                color="brand"
                className="self-start max-992:mx-auto">
                View all
              </Button>
            </div>
          </div>
          ...
          <div className="relative order-2 overflow-hidden rounded-card max-992:aspect-388/338 992:order-1 992:col-start-1 992:row-start-1 992:row-span-2 992:h-full">
            ...
            <div className="absolute left-0 top-40 rounded-tr-5 rounded-br-5 backdrop-blur-xs bg-paper-alt/80 max-768:size-72 max-768:p-10 size-80 px-24 py-14">
              {events.map((event, index) => (
                <div
                  key={event.date}
                  className={cn(
                  ...
                  <span className="font-body max-768:text-12 text-13 tracking-5 text-accent uppercase">
                    {event.badge.day}
                  </span>
                  <span className="font-body max-768:text-18 text-21 tracking-5 text-accent uppercase">
                    {event.badge.date}
                  </span>
                  <span className="font-body max-768:text-12 text-13 tracking-5 text-accent uppercase">
                    {event.badge.month}
              ...
              <div
                ...
                <div
                  ...
                  <Heading
                    ...
                    color="brand"
                    uppercase={false}
                    className="capitalize mb-20 block">
                    {event.title}
                  </Heading>
