...
const introBlock = (
  <>
    ...
    <Prose color="ink-light" className="max-992:max-w-full 992:max-w-529">
      From sunrise penguin walks at Boulders Beach to sundowner picnics on the
      shoreline — The President unlocks Cape Town for you.
    </Prose>
    <Button
      as="a"
      href="/experiences/"
    ...
    <section className="general-padding bg-paper-alt/40 overflow-hidden">
      <Container variant="lg" className="max-992:px-26">
        ...
        <div className="max-992:hidden 1024:pl-38 1024:pr-22">
          <div className="grid grid-cols-2 1024:grid-cols-[minmax(42.153vw,_1fr)_minmax(43.264vw,_1fr)] gap-30">
