      ...
      <Container variant="sm" className="max-992:px-15!">
        <div className="relative overflow-hidden rounded-card bg-mint/50 pl-26 pr-[13%] py-100 992:pl-90 992:pr-[15%] 992:pt-180 992:pb-180">
          <motion.div
            ...
            <div className="absolute max-992:-bottom-35 max-992:-right-25 max-992:w-301 max-992:aspect-301/220 -bottom-95 -right-95 rotate-[6.69deg] aspect-888/585 w-767 1199:w-837 bg-paper overflow-hidden rounded-card shadow-card origin-center">
              <Image
                src="/images/testimonial-paper-texture.webp"
                alt=""
                fill
                sizes="500px"
            ...
            <div className="relative z-10 origin-center shadow-card">
              <Stack
                gap={16}
                tabletGap={16}
                mobileGap={16}
                className="overflow-hidden rounded-card bg-paper shadow-card 992:aspect-888/796 1199:aspect-888/651 992:flex-row 992:p-16">
                <div className="relative h-260 w-full shrink-0 992:h-full 1023:w-380 max-1023:hidden">
                ...
                <div className="hidden w-px self-stretch bg-brand-muted/40 1023:block" />
                ...
                <Stack
                  ...
                  <div className="flex items-center justify-end">
                    <img
                      src="/images/testimonial-postmark.svg"
                      alt=""
                      className="max-992:w-23 w-68 opacity-15 -mr-16"
                    />
                  ...
                  <Stack
                    ...
                    tabletGap={32}
                    mobileGap={32}
                    className="relative max-640:max-w-261 1023:max-w-390">
                    <p
                    ...
                    <span className="font-body max-992:text-8 max-992:tracking-10 text-11 tracking-5 text-brand-muted uppercase">
                      - Louise M
                    </span>
                  </Stack>

                  <div className="pointer-events-none relative flex justify-center mix-blend-multiply opacity-15 max-992:hidden">
                    <div className="relative 1023:h-204 w-274">
                      <Image
