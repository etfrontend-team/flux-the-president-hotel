...
const DISCOVER_CARDS: DiscoverCard[] = [
  {
    title: "Stay",
    caption:
      "Amet consectetur. Ullamcorper quam pellentesque porttitor nisi quis bibendum tristique consequat orci.",
    ...
    <section className="general-padding bg-paper overflow-hidden">
      <Container variant="lg" className="1024:max-w-930 mx-auto">
        ...
        <Stack
          ...
          tabletGap={15}
          mobileGap={15}
          className="@container mt-50 max-767:hidden">
...
function DiscoverCardPanel({
  ...
  return (
    <Link
      ...
      style={
        { "--grow": isActive ? EXPANDED_GROW : COLLAPSED_GROW } as CSSProperties
      }
      className={cn(
