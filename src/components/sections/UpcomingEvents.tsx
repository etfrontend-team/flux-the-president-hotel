            ...
            {EVENTS.map((event) => (
              <FadeIn key={event.title}>
                <article className="group flex flex-col gap-35 max-992:gap-40">
                  <Link
                    href={event.href}
                    className="relative aspect-square w-full overflow-hidden rounded-card max-992:aspect-388/338">
                    <Image
                      src={event.image}
                      alt={event.alt}
                      fill
                    ...
                    />
                    <div className="absolute left-0 top-40 flex size-80 flex-col items-center justify-center rounded-tr-5 rounded-br-5 backdrop-blur-xs bg-paper-alt/80 px-24 py-14 max-992:size-72 max-992:p-10">
