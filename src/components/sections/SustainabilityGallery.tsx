    ...
    <section className="general-padding">
      <Container variant="lg">
        <Stack
          ...
          tabletGap={70}
          mobileGap={50}
          className="1024:pl-38 1024:pr-59 px-11">
          <FadeIn>
            <Stack align="start" gap={30} tabletGap={30} mobileGap={30}>
              ...
              <Stack gap={35} tabletGap={35} mobileGap={35}>
                ...
                <Prose color="ink-light" className="max-w-705">
                  ...
                  hold a Green Key certification and partner with SANCCOB, the
                  African penguin conservation charity.
                </Prose>
              </Stack>
              <Button
                as="a"
                href="/sustainability/sanccob-penguins"
                variant="glass"
                color="brand">
