  ...
  return (
    <section className="general-padding relative overflow-hidden bg-paper max-992:mt-15 mt-25">
      ...
      <Container variant="lg" className="relative">
        <div className="grid grid-cols-1 items-center gap-40 1023:grid-cols-3 1199:grid-cols-[343px_1fr_343px] max-992:px-25 1024:px-38">
          <div className="relative hidden aspect-343/383 overflow-hidden rounded-5 1023:block">
            <Image
          ...
          <Stack align="center" gap={50} tabletGap={50} mobileGap={50}>
            <Stack
              ...
              <Prose color="ink-light" className="max-w-404">
                Get our best rates, latest stories, and stay up to date with
            ...
            <form
              ...
              className="flex flex-col items-center gap-50">
