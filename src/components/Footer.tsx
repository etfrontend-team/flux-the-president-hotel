...
const partnerLogos = [
  {
    src: "/images/logo-preferred-pride.webp",
    alt: "Preferred Pride",
    className: "h-30 w-auto 992:h-49",
  },
  {
  ...
  return (
    <footer data-footer className="relative">
      <div className="relative overflow-hidden rounded-card bg-brand max-992:m-15 max-992:mb-0 m-25 mb-0">
        ...
        <Container className="relative flex flex-col items-center max-992:px-25 max-992:py-50 pt-54 pb-40 992:px-35">
          ...
          <Stack
            ...
            <Stack
              ...
              tabletGap={20}
              mobileGap={25}
              className="text-15 leading-12 tracking-10 text-paper 992:items-start">
              <p className="w-full text-center font-normal uppercase 992:w-auto 992:text-left">
                Contact
              </p>
              <Stack
                ...
                tabletGap={15}
                mobileGap={18}
                className="text-14 leading-copy font-light tracking-5 text-white 992:items-start">
                <Stack
                  direction="row"
                  align="center"
                  gap={15}
                  tabletGap={15}
                  mobileGap={15}
                  className="992:flex-col 992:items-start">
                  <Link
          ...
          <Stack
            ...
            tabletGap={30}
            mobileGap={30}
            className="w-full max-w-content 992:flex-row 992:flex-wrap 992:justify-around">
            <Stack
              direction="row"
              align="center"
              gap={35}
              tabletGap={35}
              mobileGap={35}
              className="order-3 text-12 leading-12 tracking-10 text-paper font-light capitalize 992:order-0">
            ...
            <div className="order-1 flex flex-wrap items-center justify-center gap-x-20 1199:gap-x-40 gap-y-15 992:order-0">
